...
export default function App() {
  ...
  const ctx = useMemo(() => ({
    ...
    resetAll: () => {
      if (!confirm("Resetar tudo? Isso apaga apontamentos, desvios, auditoria e cadastros locais.")) return;
      setState(seedState());
      clearSession();
      setSession(null);
    },
        ...
        <div className="layout">
          <aside className="sidebar">
            ...
            <div className="btnRow">
              ...
              {ctx.can("RESET_APP") ? <button className="danger" onClick={ctx.resetAll}>Reset</button> : null}
            </div>
          ...
          <main className="content">
            <div className="container">
              <Routes>
                ...
                <Route path="/kpi-moagem-sho" element={<Protected user={currentUser} allowed="VIEW_DASHBOARD"><KpiMoagemSHO /></Protected>} />
